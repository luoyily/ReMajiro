...
pub fn physical_key_to_vk(key: PhysicalKey) -> Option<u8> {
    let code = match key {
    ...
    Some(
        match code {
            ...
            KeyCode::Quote => 0xDE,
            KeyCode::NumpadBackspace => 0x08,
            KeyCode::NumpadClear => 0x0C,
            _ => return None,
        },
    )
}
pub fn mouse_wheel_to_vk(delta: &MouseScrollDelta) -> Option<u8> {
